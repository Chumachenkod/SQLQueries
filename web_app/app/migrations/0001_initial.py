...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('subject_area', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='app.subjectarea')),
                ('theme', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='app.theme')),
            ],
        ),
        migrations.CreateModel(
            name='Task',
            fields=[
                ...
                ('key_words', models.ManyToManyField(to='app.keyword')),
                ('task_group', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='app.taskgroup')),
            ],
        ),
        migrations.CreateModel(
            name='Grade',
